        ...
        <div className="container relative py-16 md:py-24">
          <div className="grid grid-cols-1 pb-8 text-center">
            ...
            <p className="mx-auto max-w-xl text-slate-400">
              Con un enfoque en la innovación, la inclusión y el aprendizaje continuo, ellos son
              quienes hacen posible que cada charla, taller y encuentro sea un espacio de
              inspiración y crecimiento. ¡Conoce a las mentes brillantes que hacen de MedellínJS un
              referente en la comunidad tech!
            </p>
          </div>
