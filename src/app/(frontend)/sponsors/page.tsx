...
import { ServiceFaq, SponsorPlan, SponsorQuotes } from '@/components/sponsors/index'
        ...
        <div className="container relative">
          <div className="mt-10 grid grid-cols-1 pb-8 text-center">
            ...
            <p className="mx-auto max-w-xl text-lg text-slate-300">
              Ofrecemos oportunidades personalizadas para que tu empresa tenga visibilidad,
              construya relaciones significativas y demuestre su compromiso con el ecosistema
              tecnológico local.
            </p>
          </div>
        </div>
      ...
      <section className="relative py-16 md:py-24">
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            ...
            <p className="mx-auto max-w-xl text-slate-400">
              Con nuestros Paquetes de Patrocinio, tu marca puede conectarse con desarrolladores,
              innovadores y líderes de la industria mientras apoyas el crecimiento y la educación en
              tecnología.
            </p>
          </div>
        ...
        <div className="container relative py-16 md:py-24">
          <div className="grid grid-cols-1 pb-8 text-center">
            ...
            <p className="mx-auto max-w-xl text-slate-400">
              ¿Quieres patrocinar y aportar a una de las comunidades tech más vibrantes de Medellín?
            </p>
          </div>
