      ...
      <section className="relative table w-full bg-gray-50 py-32 dark:bg-slate-800 lg:py-40">
        <div className="container relative">
          <div className="mt-10 grid grid-cols-1 text-center">
            <h3 className="text-3xl font-semibold leading-normal">Política de Privacidad</h3>
          </div>
        </div>
          ...
          <div className="justify-center md:flex">
            <div className="md:w-3/4">
              <div className="rounded-md bg-white p-6 shadow dark:bg-slate-900 dark:shadow-gray-800">
                <h5 className="mb-4 text-xl font-semibold">Política de Privacidad:</h5>
                <p className="text-slate-400">
                  En MedellinJS, nos tomamos tu privacidad en serio. Esta política explica qué datos
                  recopilamos, cómo los usamos y qué derechos tienes como usuario.
                </p>

                <h5 className="mb-4 mt-8 text-xl font-semibold">¿Qué datos recopilamos?</h5>
                <p className="text-slate-400">
                ...
                <h5 className="mb-4 mt-8 text-xl font-semibold">¿Cómo usamos tus datos?</h5>
                ...
                <ul className="mt-4 list-none text-slate-400">
                  ...
                  <li className="mt-2 flex items-center">
                    <FaArrowRight className="me-2 ms-2 align-middle text-[10px] text-indigo-600" />{' '}
                    Enviarte recordatorios o actualizaciones importantes sobre eventos
                  </li>
                  <li className="mt-2 flex items-center">
                    <FaArrowRight className="me-2 ms-2 align-middle text-[10px] text-indigo-600" />{' '}
                    Entender mejor el perfil de nuestra comunidad (de forma agregada y anónima)
                  </li>
                </ul>

                <h5 className="mb-4 mt-8 text-xl font-semibold">Servicios de terceros</h5>
                <p className="text-slate-400">
                  Utilizamos servicios de autenticación de Google y LinkedIn. Estos servicios
                  gestionan tu inicio de sesión y nos envían solo la información básica que
                  autorizas compartir.
                </p>
                <p className="text-slate-400">
                  También usamos herramientas de análisis (como Google Analytics) para entender el
                  uso del sitio. Estos datos son anónimos y no se pueden usar para identificarte.
                </p>

                <h5 className="mb-4 mt-8 text-xl font-semibold">Tus derechos</h5>
                ...
                <p className="text-slate-400">
                  ...
                  <Link href="mailto:info@medellinjs.org">info@medellinjs.org</Link>.
                </p>

                <h5 className="mb-4 mt-8 text-xl font-semibold">Cambios a esta política</h5>
                <p className="text-slate-400">
                  Podemos actualizar esta política si cambiamos cómo manejamos tus datos. Si hacemos
                  cambios importantes, te lo haremos saber por correo o en el sitio.
                </p>
